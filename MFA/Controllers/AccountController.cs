...
namespace Authenticator.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult LoginUser(string username, string password)
        {
            ...
            {
                ViewBag.SigninMessage = "Password isn't correct";
                return View("Login");
            }
        }
        ...
        public IActionResult RegisterUser(string username, string password)
        {
            ...
            _ = _dbContext.Users.Add(newUser);
        ...
        public IActionResult RegisterMFASecret(string AuthCode)
        {
            ...
            object? secret = TempData["MFASecret"];
            ...
            Totp totp = new Totp(Base32Encoding.ToBytes(secret.ToString()));
            string totpCode = totp.ComputeTotp(DateTime.UtcNow.AddSeconds(-1));
            ...
            {
                ViewBag.UserManagementMessage = "Wrong code! Try again!";
        ...
        public IActionResult VerifyMFA(string AuthCode)
        {
            ...
            int? Counter = HttpContext.Session.GetInt32("OTPCounter");
            if (UserId != null && Counter.HasValue && Counter > 0)
            {
                ...
                Users? user = _dbContext.Users.Where(s => s.Id == UserId).FirstOrDefault();
                ...
                else
                {
                    ...
                    if (remainingCounter <= 0)
                    {
                        ...
                        ViewBag.SigninMessage = "You need to login again!";
                        Response.StatusCode = 401;
                        return Redirect("Login");
                    }

                    ViewBag.MFAMessage = "Wrong code! Try again!";
